...
public class SQLConstants {
    ...
    public static final String GET_ALL_ASSOCIATIONS_COUNT_BY_TENANT_QUERY = "SELECT COUNT(WORKFLOW_ID) FROM WF_WORKFLOW, WF_WORKFLOW_ASSOCIATION WHERE WF_WORKFLOW.ID = WF_WORKFLOW_ASSOCIATION.WORKFLOW_ID AND WF_WORKFLOW.TENANT_ID = ?";

    public static final String GET_ASSOCIATIONS_COUNT_BY_TENANT_QUERY = "SELECT COUNT(WORKFLOW_ID) FROM WF_WORKFLOW, WF_WORKFLOW_ASSOCIATION WHERE WF_WORKFLOW.ID = WF_WORKFLOW_ASSOCIATION.WORKFLOW_ID AND WF_WORKFLOW.TENANT_ID = ? AND ASSOC_NAME LIKE ?";
